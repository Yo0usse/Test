...
client.on("messageCreate", async (message) => {
    ...
    if (command === "play") {
        ...
        if (loadType === 'playlist') {
            ...
            .setAuthor({
                name: 'Added To Queue',
                iconURL: 'https://cdn.discordapp.com/emojis/1263135320950440038.webp?size=96&quality=lossless', 
                url: 'https://discord.gg/CkKqVantwY'
            })
        ...
        .setAuthor({
          ...
          iconURL: 'https://cdn.discordapp.com/emojis/1263135478266204183.webp?size=96&quality=lossless',
          url: 'https://discord.gg/CkKqVantwY'
        })
        ...
        chunks.forEach(chunk => {
            ...
            .setAuthor({
                 name: 'Queue',
                 iconURL: 'https://cdn.discordapp.com/emojis/1236810543009107989.webp?size=96&quality=lossless',
                 url: 'https://discord.gg/CkKqVantwY'
               })
...
client.riffy.on("trackStart", async (player, track) => {
    ...
    const musicEmbed = new EmbedBuilder()
        ...
        .setAuthor({
            ...
            iconURL: 'https://cdn.discordapp.com/emojis/913774959522885682.gif?size=96&quality=lossless', 
            url: 'https://discord.gg/CkKqVantwY'
          })
...
client.riffy.on("queueEnd", async (player) => {
    ...
    if (autoplay) {
        ...
        .setAuthor({
          ...
          .setDescription('**There is No Songs To Play...**');
